    ...
    <section className='news-section' id="news">
      ...
      <div className="news-content d-flex">
        <div className="cover-img d-flex position-relative">
          <img src="https://assets.bcci.tv/bcci/articles/1749911175_BCCI_Thumbnail.png" alt="Board of Control for Cricket in India (BCCI) invites proposals for provision of verification services for player registration" />
        ...
        <div className="side-news-content">
          <div className="side-news">
            <div className="side-img">
              <img src="https://assets.bcci.tv/bcci/articles/1754046995_BCCI_Thumbnail.png" alt="Board of Control for Cricket in India (BCCI) invites proposals for accreditation services" />
            </div>
