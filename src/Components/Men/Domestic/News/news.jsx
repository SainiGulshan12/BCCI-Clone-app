      ...
      <div className="news-content d-flex">
        <div className="cover-img d-flex position-relative">
          ...
          <div className="coverImg-caption position-absolute bottom-0">
            ...
            <h2>BCCI invites proposals for provision of broadcast graphics services for BCCI’s domestic seasons</h2>
            <p className="d-flex align-items-center justify-content-between">3rd July, 2025 <span> <IoShareSocialOutline className='shareIcon' /> </span> </p>
          </div>
        </div>
        <div className="side-news-content">
          ...
          <div className="side-news">
            ...
            <div className="news-text">
              <h6>21st January, 2025 </h6>
              <h3>A special century: Anil Dandekar set to umpire 100th First Class match as BCCI...</h3>
              <p className="mb-0 text-end"><IoShareSocialOutline className="share-icon" /></p>
            </div>
          </div>
