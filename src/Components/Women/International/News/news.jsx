            ...
            <div className="news-content d-flex">
                <div className="cover-img d-flex position-relative">
                    ...
                    <div className="coverImg-caption position-absolute bottom-0">
                        ...
                        <p className="d-flex align-items-center justify-content-between">01st August, 2025 <span> <IoShareSocialOutline className='shareIcon' /> </span> </p>
                    </div>
                </div>
                <div className="side-news-content">
                    <div className="side-news">
                        <div className="side-img">
                            <img src="https://assets.bcci.tv/bcci/articles/1753343532_BCCI___Thumbnail.png" alt="Squad Update: India A Women’s Tour of Australia 2025" />
                        </div>
                        <div className="news-text">
                            <h6>24th July, 2025 </h6>
                            <h3>Squad Update: India A Women’s Tour of Australia 2025</h3>
                        </div>
                        <p className="share-div mb-0"><IoShareSocialOutline className="share-icon" /></p>
                    </div>
                    <div className="side-news">
                        <div className="side-img">
                            <img src="https://assets.bcci.tv/bcci/articles/1753343532_BCCI___Thumbnail.png" alt="Board of Control for Cricket in India (BCCI) invites proposals for accreditation services" />
                        </div>
                        <div className="news-text">
